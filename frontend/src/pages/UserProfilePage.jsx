...
function UserProfilePage() {
  ...
  // Determine if the "Request Swap" button should be shown
          ...
          <div className="col-md-8">
            ...
            {skillsOffered.length > 0 ? (
              skillsOffered.map(skill => (
                <span key={skill.id} className="badge fs-6 bg-primary-subtle text-primary-emphasis rounded-pill me-2 mb-2 p-2">
                  {skill.name}
                </span>
              ))
            ) : (
            ...
            {skillsWanted.length > 0 ? (
              skillsWanted.map(skill => (
                <span key={skill.id} className="badge fs-6 bg-secondary-subtle text-secondary-emphasis rounded-pill me-2 mb-2 p-2">
                  {skill.name}
                </span>
              ))
            ) : (
